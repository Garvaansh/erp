...
export async function createPurchaseOrder(
  ...
  return apiClient<CreatePOResult>("/procurement/orders", {
    method: "POST",
...
export async function receivePurchaseOrderStock(
  ...
  return apiClient<ReceiveStockResult>("/procurement/receive", {
    method: "POST",
    body: JSON.stringify({
      po_id: parsed.po_id,
...
export async function voidProcurementReceipt(
  data: VoidReceiptInput,
): Promise<VoidReceiptResult> {
  const parsed = VoidReceiptSchema.parse(data);

  return apiClient<VoidReceiptResult>("/procurement/void-receipt", {
    method: "POST",
    body: JSON.stringify(parsed),
  });
}
