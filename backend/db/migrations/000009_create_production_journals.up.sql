-- ==========================================
-- 9. PRODUCTION JOURNALS (The Daily Log)
-- ==========================================
CREATE TABLE production_journals (
    ...
    input_location_id UUID NOT NULL REFERENCES inventory_locations(id),
    output_location_id UUID NOT NULL REFERENCES inventory_locations(id),
